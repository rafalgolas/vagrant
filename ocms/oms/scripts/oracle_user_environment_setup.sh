...
export ORACLE_HOSTNAME=${OMS_FQ_HOSTNAME}
export ORACLE_UNQNAME=${ORACLE_UNQNAME}
export ORACLE_BASE=${ORACLE_BASE}
export ORA_INVENTORY=${ORA_INVENTORY}
export GRID_HOME=${GRID_HOME}
export DB_HOME=\$ORACLE_BASE/${DB_HOME_OMS}
export ORACLE_HOME=\$DB_HOME
export ORACLE_SID=${OMS_ORACLE_SID}
...
cat > /home/oracle/oms.env <<EOF
export ORACLE_SID=${OMS_ORACLE_SID}
export ORACLE_HOME=${OMS_MIDDLEWARE_HOME}/oms
export PATH=\$ORACLE_HOME/bin:\$BASE_PATH
